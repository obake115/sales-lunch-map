...
const KANSAI_PREFS = [
  { id: 'mie', key: 'prefectures.mie' },
  { id: 'shiga', key: 'prefectures.shiga' },
  { id: 'kyoto', key: 'prefectures.kyoto' },
  { id: 'osaka', key: 'prefectures.osaka' },
  { id: 'hyogo', key: 'prefectures.hyogo' },
  { id: 'nara', key: 'prefectures.nara' },
  { id: 'wakayama', key: 'prefectures.wakayama' },
];

export default function KansaiScreen() {
  ...
  return (
    <View style={{ flex: 1 }}>
      <ImageBackground
        source={require('@/assets/images/kansai-highlight.png')}
        style={UI.bg}
        resizeMode="cover"
      />
      <View style={UI.overlay} />
      <ScrollView contentContainerStyle={{ padding: 16, paddingBottom: 110 }}>
        <Text style={[UI.title, { color: colors.text }]}>{t('regions.kansai')}</Text>
