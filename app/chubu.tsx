...
const CHUBU_PREFS = [
  { id: 'niigata', key: 'prefectures.niigata' },
  { id: 'toyama', key: 'prefectures.toyama' },
  { id: 'ishikawa', key: 'prefectures.ishikawa' },
  { id: 'fukui', key: 'prefectures.fukui' },
  { id: 'yamanashi', key: 'prefectures.yamanashi' },
  { id: 'nagano', key: 'prefectures.nagano' },
  { id: 'gifu', key: 'prefectures.gifu' },
  { id: 'shizuoka', key: 'prefectures.shizuoka' },
  { id: 'aichi', key: 'prefectures.aichi' },
];

export default function ChubuScreen() {
  ...
  return (
    <View style={{ flex: 1 }}>
      <ImageBackground
        source={require('@/assets/images/chubu-highlight.png')}
        style={UI.bg}
        resizeMode="cover"
      />
      <View style={UI.overlay} />
      <ScrollView contentContainerStyle={{ padding: 16, paddingBottom: 110 }}>
        <Text style={[UI.title, { color: colors.text }]}>{t('regions.chubu')}</Text>
