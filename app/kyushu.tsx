...
const KYUSHU_PREFS = [
  { id: 'fukuoka', key: 'prefectures.fukuoka' },
  { id: 'saga', key: 'prefectures.saga' },
  { id: 'nagasaki', key: 'prefectures.nagasaki' },
  { id: 'kumamoto', key: 'prefectures.kumamoto' },
  { id: 'oita', key: 'prefectures.oita' },
  { id: 'miyazaki', key: 'prefectures.miyazaki' },
  { id: 'kagoshima', key: 'prefectures.kagoshima' },
  { id: 'okinawa', key: 'prefectures.okinawa' },
];

export default function KyushuScreen() {
  ...
  return (
    <View style={{ flex: 1 }}>
      <ImageBackground
        source={require('@/assets/images/kyushu-highlight.png')}
        style={UI.bg}
        resizeMode="cover"
      />
      <View style={UI.overlay} />
      <ScrollView contentContainerStyle={{ padding: 16, paddingBottom: 110 }}>
        <Text style={[UI.title, { color: colors.text }]}>{t('regions.kyushu')}</Text>
