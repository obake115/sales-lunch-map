...
const SHIKOKU_PREFS = [
  { id: 'tokushima', key: 'prefectures.tokushima' },
  { id: 'kagawa', key: 'prefectures.kagawa' },
  { id: 'ehime', key: 'prefectures.ehime' },
  { id: 'kochi', key: 'prefectures.kochi' },
];

export default function ShikokuScreen() {
  ...
  return (
    <View style={{ flex: 1 }}>
      <ImageBackground
        source={require('@/assets/images/shikoku-highlight.png')}
        style={UI.bg}
        resizeMode="cover"
      />
      <View style={UI.overlay} />
      <ScrollView contentContainerStyle={{ padding: 16, paddingBottom: 110 }}>
        <Text style={[UI.title, { color: colors.text }]}>{t('regions.shikoku')}</Text>
