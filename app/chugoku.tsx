...
const CHUGOKU_PREFS = [
  { id: 'tottori', key: 'prefectures.tottori' },
  { id: 'shimane', key: 'prefectures.shimane' },
  { id: 'okayama', key: 'prefectures.okayama' },
  { id: 'hiroshima', key: 'prefectures.hiroshima' },
  { id: 'yamaguchi', key: 'prefectures.yamaguchi' },
];

export default function ChugokuScreen() {
  ...
  return (
    <View style={{ flex: 1 }}>
      <ImageBackground
        source={require('@/assets/images/chugoku-highlight.png')}
        style={UI.bg}
        resizeMode="cover"
      />
      <View style={UI.overlay} />
      <ScrollView contentContainerStyle={{ padding: 16, paddingBottom: 110 }}>
        <Text style={[UI.title, { color: colors.text }]}>{t('regions.chugoku')}</Text>
